...
#  this will return full url path inside our project
...
class PublicUserApiTest(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test an error if the password is less than 6 chars."""
        payload = {
            'email': 'test@example.com',
            'password': 'pass',
            'name': 'Test Name',
    ...
    def test_create_token_for_user(self):
        ...
        # payload sent to the token api in order to log in
        payload = {
            'email': 'test@example.com',
            'password': 'testpass123',
        }
    ...
    def test_create_token_bad_credentials(self):
        """Test token for bad credentials"""
    ...
    def test_create_token_blank_password(self):
        """Test posting blank password give errro"""
        payload = {
    ...
    def test_retrieve_user_unauthorized(self):
        ...
        # expect error when we hit without doing authentication.
...
class PrivateUserApiTests(TestCase):
    ...
    def tes_post_me_not_allowed(self):
    ...
    def test_update_email_not_allowed(self):
        """Test user not able to update mail."""
        new_email = 'updateemail@example.com'
        ...
        self.assertEqual(res.data['email'][0], 'You cannot change your email address.')
        self.user.refresh_from_db()
